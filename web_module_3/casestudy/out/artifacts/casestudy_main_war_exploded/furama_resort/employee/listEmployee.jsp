            ...
            <div class="navbar-collapse">
                <ul id="menu-furama-vi" class="menu navbar-nav js-main-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/employees" id="navbarDropdown" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            SERVICE
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/employees">All Facilities</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="/employees?action=villa">VILLA</a></li>
                            <li><a class="dropdown-item" href="/employees?action=house">HOUSE</a></li>
                            <li><a class="dropdown-item" href="/employees?action=room">ROOM</a></li>
                        </ul>
                    </li>
    ...
    <div class="row" style="width: 100%; padding: 0; margin: 0;">
        <div id="left" class="col-2">
            <ul id="ul_left" style="list-style-type: none; margin-left: -25px; margin-top: 50px">
                <li><a href="/employees?action=create" class="btn btn-primary" role="button">Thêm mới sản phẩm</a></li>
        ...
        <div id="content" class="col-10">
            ...
            <table id="facility_table" class="table table-striped table-bordered" style="width: 100%">
                ...
                <tbody>
                <c:forEach var="facility" items="${employees}" varStatus="status">
                    <tr>
                        <td>${status.count}</td>
                        <td>${facility.id}</td>
                            <%--                        <td><a href="/employees?action=view&id=${facility.id}">${facility.name}</a></td>--%>
                        <td>${facility.name}</td>
                        ...
                        <td><a href="/employees?action=edit&id=${facility.id}" class="btn btn-warning">Chỉnh sửa</a>
                        </td>
