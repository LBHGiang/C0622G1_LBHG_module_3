                ...
                <form action="/employees?action=create" method="post">
                    <fieldset style="width: 50%; margin-left: 25%">
                        ...
                        <table class="table table-striped" style="text-align: left">
                            <tr>
                                <td>Tên</td>
                                <td><input type="text" name="name" id="name" value="${employee.name}"
                            ...
                            <tr>
                                <td>Ngày sinh</td>
                                <td><input type="date" name="birthday" id="birthday" value="${employee.birthday}"
                                           required oninvalid="this.setCustomValidity('Vui lòng không để trống!')"
                                           oninput="setCustomValidity('')">
                                    <div style="color:red;">${error.get('birthday')}</div>
                                </td>
                            </tr>
                            <tr>
                                <td>CMND</td>
                                <td><input type="text" name="idCard" id="idCard" value="${employee.idCard}"
                                           required oninvalid="this.setCustomValidity('Vui lòng không để trống!')"
                                           oninput="setCustomValidity('')">
                            ...
                            <tr>
                                <td>Lương</td>
                                <td><input type="number" name="salary" id="salary" value="${employee.salary}"
                                           required oninvalid="this.setCustomValidity('Vui lòng không để trống!')"
                                           oninput="setCustomValidity('')">
                            ...
                            <tr>
                                <td>Email</td>
                                <td><input type="text" name="email" id="email" value="${employee.email}"
                                           required oninvalid="this.setCustomValidity('Vui lòng không để trống!')"
                                           oninput="setCustomValidity('')">
                            ...
                            <tr>
                                <td>Địa chỉ</td>
                                <td><input type="text" name="address" id="address" value="${employee.address}"
                                           required oninvalid="this.setCustomValidity('Vui lòng không để trống!')"
                                           oninput="setCustomValidity('')">
                                    <div style="color:red;">${error.get('address')}</div>
                                </td>
                            </tr>
                            <tr>
                                <td>Chức vụ</td>
                            ...
                            <tr>
                                <td><a href="/employees?action=create" class="btn btn-primary" role="button">Xóa tất cả
                                    dữ
                                    liệu</a></td>
                                <td><input required type="submit" value="Thêm mới" class="btn btn-primary"></td>
                            </tr>
                        </table>
                    </fieldset>
                </form>
