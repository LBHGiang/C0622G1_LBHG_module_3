    ...
    <div class="row" style="width: 100%; padding: 0; margin: 0;">
        <div id="left" class="col-2">
            <ul id="ul_left" style="list-style-type: none; margin-left: -25px; margin-top: 50px">
                <li style="margin: 10px"><a href="/facilities?" class="btn btn-primary" role="button">Quay lại Dịch
                    vụ</a></li>
            ...
            <form method="post">
                <fieldset style="width: 50%; margin-left: 25%">
                    ...
                    <table class="table table-striped" style="text-align: left">
                        ...
                        <tr>
                            <td>Kiểu dịch vụ</td>
                            <td><input type="hidden" name="serviceType" value="${facility.facilityTypeId}">
                                ${serviceType.get(facility.facilityTypeId)}
                            </td>
                        ...
                        <tr>
                            <td>Mô tả</td>
                            <td><input type="text" name="description" id="description" value="${facility.description}">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="freeService" id="freeService"
                                       value="${facility.facilityFree}"></td>
                        </tr>
                        <tr>
                            <td><a href="/facilities" class="btn btn-primary" role="button">Hủy bỏ</a></td>
