        ...
        <nav class="navbar navbar-expand-lg">
            <div class="navbar-collapse">
                ...
                <form class="d-flex m-0 p-0 align-items-center justify-content-end" style="flex: 1"
                      action="/facilities?action=find" method="post">
    ...
    <div class="row" style="width: 100%; padding: 0; margin: 0;">
        <div id="left" class="col-2">
            <ul id="ul_left" style="list-style-type: none; margin-left: -25px; margin-top: 50px">
                <li><a href="/facilities?action=create" class="btn btn-primary" role="button">Thêm mới dịch vụ</a></li>
        ...
        <div id="content" class="col-10">
            ...
            <table id="facility_table" class="table table-striped table-bordered" style="width: 100%">
                ...
                <c:forEach var="facility" items="${facilities}" varStatus="status">
                    <tr>
                        <td>${status.count}<input type="hidden" name="id" value="${facility.id}"></td>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="/facilities" class="btn btn-secondary" data-bs-dismiss="modal">Hủy bỏ</a>
