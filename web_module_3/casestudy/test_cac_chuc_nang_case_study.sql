...
SELECT * FROM data_furama.facility where is_delete=0 and name like "%a%" and cost < 103022000 and facility_type_id = 1;

SELECT * FROM data_furama.employee where is_delete=0 and name like "%a%" and division_id = 1; 
SELECT * FROM data_furama.employee where is_delete=0 and name like ?;
SELECT * FROM data_furama.employee where is_delete=0 and name like ? and division_id = ?; 
